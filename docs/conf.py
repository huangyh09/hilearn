...
title = "A small library of machine learning tools and plottings."
...
import hilearn
version = hilearn.__version__ #'0.1.3' #
...
latex_documents = [
  ('index', 'HiLearn.tex', u'HiLearn Documentation',
...
man_pages = [
    ('index', 'HiLearn', u'HiLearn Documentation',
     [u'Yuanhua Huang'], 1)
]
...
texinfo_documents = [
  ('index', 'HiLearn', u'HiLearn Documentation',
   u'Yuanhua Huang', 'HiLearn', 'One line description of project.',
   'Miscellaneous'),
]
